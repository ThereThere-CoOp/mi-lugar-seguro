...
const Data := preload('inventory_item_lipstick_state.gd')

var state: Data = load("res://game/inventory_items/lipstick/inventory_item_lipstick.tres")
...
func _on_right_click() -> void:
	await C.Mel.say("Es mi color preferido para los labios.")
	await C.Mel.say("Lo puedo usar en el espejo de mi vanity para pintarme.")
